...
df_filtered_activation_status |>
  ...
  geom_segment(
    ...
    aes(x = as.numeric(factor(adm1_name)) - 0.3,
        ...
        y = thresh_4,
        yend = thresh_4), color = hdx_hex("tomato-hdx"),linetype = "dashed"
  )+
  geom_text(
    aes(
  ...
  labs(
    title = "Seasonal Precipitation Forecast: March-April-May",
    subtitle = "4 year return period rainfall deficit threshold shown as red line",
    caption = "Forecast publication: Feb 2025\nData Source: ECMWF SEAS5"
  )+
  theme(
