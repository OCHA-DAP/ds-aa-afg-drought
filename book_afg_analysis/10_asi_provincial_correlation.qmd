...
# Create metrics labels for top axis annotation (stacked vertically)
df_top_labels <- df_metrics |>
    ...
    add_row(indicator_label = "CERF Allocation", metrics_label = "")
...
ggplot(df_heatmap, aes(x = indicator, y = factor(year), fill = fill_group)) +
    ...
    labs(
        ...
        subtitle = "Metrics calculated from 2006-2025 | Red = individual indicators, Green = joint triggers & CERF",
        x = "Indicator",
        y = "Year"
    ) +
    theme_minimal() +
